export default function (name, confirmURL) {
  return `
<!doctype html>
<html>
						...
						<tr>
							<td class="wrapper"
								...
								<table border="0" cellpadding="0" cellspacing="0"
									...
									<tr>
										<td style="font-family: sans-serif; font-size:20px; vertical-align: top;">
											<p
												style="font-family: sans-serif; font-size: 24px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
												<b>${name},</b> это письмо с инструкциями по смене пароля к профилю пользователя магазина
												WATCH-EXPERT
											</p>
												...
												<tbody>
													<tr>
														<td align="center"
															...
															<img src="cid:email-reset-password" alt="email-confirmation" width="300"
																height="300" border="0"
											...
											<p
												...
												Для сброса старого пароля и установления нового пароля нажмите на кнопку "Сменить пароль". Ссылка на восстановление пароля действительна в течение одно часа.
											</p>
											<table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary"
												style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">
												<tbody>
														...
														<td align="center"
															...
															<table border="0" cellpadding="0" cellspacing="0"
																...
																<tbody>
																	<tr>
																		<td
																			style="font-family: sans-serif; font-size:20px; vertical-align: top; background-color: #009746; border-radius: 5px; text-align: center;">
																			<a href="${confirmURL}" target="_blank"
																				style="display: inline-block; color: #ffffff; background-color: #009746; border: solid 1px #009746; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size:20px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #009746;">
																				Сменить пароль
																			</a>
																		</td>
																	</tr>
