									...
									<tr>
										<td style="font-family: sans-serif; font-size: 20px; vertical-align: top;">
											<p
												...
												<b>${name},</b> вы зарегистрировали аккаунт в магазине "WATCH-EXPERT"
											</p>
												...
												<tbody>
													<tr>
														<td align="center"
															...
															<img src="cid:email-confirmation-request" alt="email-confirmation" width="300"
																height="300" border="0"
											...
											<p
												...
												Для завершения регистрации аккаунта, необходимо подтвердить адрес электронной почты. После
												подтверждения адреса Вы сможете совершать покупки на сайте.
											</p>
											<table border="0" cellpadding="0" cellspacing="0" class="btn btn-primary"
												style="border-collapse: separate; mso-table-lspace: 0pt; mso-table-rspace: 0pt; width: 100%; box-sizing: border-box;">
												<tbody>
